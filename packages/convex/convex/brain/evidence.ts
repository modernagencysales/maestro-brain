import registeredFunctions from "../../confect/_generated/registeredFunctions/brain/evidence";
...
export const failActiveScopeRun = registeredFunctions.failActiveScopeRun;
...
export const searchForActor = registeredFunctions.searchForActor;
export const sourceGet = registeredFunctions.sourceGet;
export const sourceGetForActor = registeredFunctions.sourceGetForActor;
