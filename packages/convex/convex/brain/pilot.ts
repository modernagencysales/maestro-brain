...
export const ask = registeredFunctions.ask;
export const headlessSubmitNote = registeredFunctions.headlessSubmitNote;
export const listReviewQueue = registeredFunctions.listReviewQueue;
...
export const updatePage = registeredFunctions.updatePage;
