...
export const reviewClassificationDecision = (
  ...
  if (
    review.reviewerAuthority.workspaceId !== decision.workspaceId ||
    review.reviewerAuthority.organizationId !== decision.organizationId ||
    (review.reviewerAuthority.role !== "admin" &&
      review.reviewerAuthority.role !== "owner")
  ) {
