...
import channelSyncStatesSource from "../tables/channelSyncStates";
import sourceChannelsSource from "../tables/sourceChannels";
...
const slackDirectoryDatabaseSchema = DatabaseSchema.make({
  ...databaseSchema.tables,
  sourceChannels: sourceChannelsSource("sourceChannels"),
  channelSyncStates: channelSyncStatesSource("channelSyncStates"),
});
...
export const makeSlackDirectoryImpl = () =>
  GroupImpl.make(slackDirectoryDatabaseSchema, slackDirectory).pipe(
    Layer.provide(makeReconcileChannels()),
    GroupImpl.finalize,
  );
