...
> = Spec.make().addAt("auth", GroupSpec.makeAt("auth").addGroupAt("workspaces", auth_workspaces)).addAt("brain", GroupSpec.makeAt("brain").addGroupAt("pages", brain_pages)).addAt("capabilities", GroupSpec.makeAt("capabilities").addGroupAt("catalog", capabilities_catalog)).addAt("jobs", GroupSpec.makeAt("jobs").addGroupAt("workpool", jobs_workpool));
