...
import brain_feedback from "../brain/feedback.spec";
import brain_noteStatus from "../brain/noteStatus.spec";
...
import brain_retrievalPublication from "../brain/retrievalPublication.spec";
import brain_rolloutOperations from "../brain/rolloutOperations.spec";
import brain_rolloutStatus from "../brain/rolloutStatus.spec";
import brain_structuredQuery from "../brain/structuredQuery.spec";
...
import integrations_driveSource from "../integrations/driveSource.spec";
import integrations_providerReconciliation from "../integrations/providerReconciliation.spec";
...
const spec: Spec.Spec<
  ...
  | GroupSpec.NamedAt<GroupSpec.GroupSpec<"Convex", "brain", never, GroupSpec.NamedAt<typeof brain_callReview, "callReview"> | GroupSpec.NamedAt<typeof brain_feedback, "feedback"> | GroupSpec.NamedAt<typeof brain_noteStatus, "noteStatus"> | GroupSpec.NamedAt<typeof brain_pages, "pages"> | GroupSpec.NamedAt<typeof brain_pilot, "pilot"> | GroupSpec.NamedAt<typeof brain_readApi, "readApi"> | GroupSpec.NamedAt<typeof brain_retrievalPublication, "retrievalPublication"> | GroupSpec.NamedAt<typeof brain_rolloutOperations, "rolloutOperations"> | GroupSpec.NamedAt<typeof brain_rolloutStatus, "rolloutStatus"> | GroupSpec.NamedAt<typeof brain_structuredQuery, "structuredQuery">>, "brain">
