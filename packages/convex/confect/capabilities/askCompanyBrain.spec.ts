...
export const BrainPackCitationV4 = S.Struct({
  ...
  bodyIdentity: S.optional(S.String),
  ...
  ranking: S.Struct({
    relevance: S.Number,
    reviewState: S.Number,
    sourceAuthority: S.Number,
    freshness: S.Number,
    tagMatch: S.Number,
    corroboration: S.Number,
    total: S.Number,
  }),
});
export const ContextPackV4 = S.Struct({
  ...
  fallbackReason: S.optional(S.Literal("context-v4-disabled")),
  packHash: S.String,
  workspaceId: Id("workspaces"),
  question: S.String,
  asOf: S.Number,
