...
export const buildSourceLedgerRows = (
  ...
  return {
    ...
    processingJob: {
      schemaVersion: 1 as const,
      organizationKey: input.envelope.organizationKey,
      unitKey: keys.sourceUnitKey,
      stage: "assembled" as const,
      executionStatus: "queued" as const,
      effectKey: keys.assemblyJobKey,
      idempotencyKey: keys.assemblyJobKey,
      organizationUnitIdempotencyKey: keys.sourceUnitKey,
      policyGeneration: input.routing.policyEpoch,
      routeGeneration: 0,
      lifecycleGeneration: lifecycleValue.generation,
