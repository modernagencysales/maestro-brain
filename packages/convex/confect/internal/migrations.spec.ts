...
export type AllowedMigrationName = Schema.Schema.Type<typeof AllowedMigrationName>;
...
export type MigrationBatchRunArgs = Schema.Schema.Type<typeof MigrationBatchRunArgs>;
...
export type MigrationBatchReceipt = Schema.Schema.Type<typeof MigrationBatchReceipt>;
...
const runBatchInternal = FunctionSpec.internalMutation({
...
const listReceiptsInternal = FunctionSpec.internalQuery({
...
export default GroupSpec.make()
  .addFunction(runBatchInternal)
  .addFunction(listReceiptsInternal);
