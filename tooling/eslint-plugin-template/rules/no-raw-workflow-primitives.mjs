...
export default {
  meta: {
    ...
    schema: [],
    messages: {
      raw: "WF-RAW-IMPORT: use the generated workflow kit; raw @convex-dev/workflow imports are path-exact and have no inline escape. Rerun pnpm check:confect-contracts",
      manager:
        "WF-RAW-MANAGER: use the generated WorkflowManager boundary; application code cannot instantiate a second manager. Rerun pnpm check:confect-contracts",
    },
  },
  create(context) {
