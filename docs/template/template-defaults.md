...
| Notifications      | Provider boundary, generator path, route placeholder, and redacted notification/email seams.             | In-app notification center, read state, preferences, digests, Slack/webhook alerts, and live deliverability.         | Fork enables when it has recipient policy, opt-out posture, template copy, provider credentials, and failure alert routing.               | `packages/notifications`, `docs/template/how-to-add-notification.md`, `docs/template/client-handoff-packet.md`.                                 |
