...
- Secrets, API keys, OAuth tokens, webhook signing secrets, raw webhook payloads,
  support artifacts, provider request/response logs, and production stack
  traces.
...
use. Synthetic data should use fictional workspaces, fictional people,
fictional providers, fake ids, fake domains, fake timestamps, and fake billing
events. If the provenance of a fixture is unclear, it is rejected until proven
safe.
