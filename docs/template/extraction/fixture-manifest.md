...
| Brain evaluation safety cases   | `tooling/evals`                     | `examples/generic-ai-ops/evals/brain-*`              | External customer payloads; committed hashes only | Yes                    | Keep cases synthetic and real-task payloads outside Git.             |
