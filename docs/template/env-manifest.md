...
| Nango Connect             | `NANGO_SECRET_KEY`, `NANGO_CONNECT_INTEGRATION_ID`, `NANGO_CONNECT_PUBLIC_KEY`                                                                                                                                                                                                                                                                                                   | Integrations owner      | Slack workspace authorization through Nango Connect                                    | Fake values create deterministic local Connect sessions and never require Slack credentials                                                                   | Required only when Slack Connect is enabled; secret key stays server-side and Slack access/refresh tokens remain in Nango                                             | Rotate before live enablement, after integration admin changes, and after any suspected callback/session exposure |
