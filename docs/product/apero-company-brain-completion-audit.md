...
HTTP MCP use the same exact source/revision identities; source reopening verifies
the stored content hash; connection revocation fails closed; and only a completed
