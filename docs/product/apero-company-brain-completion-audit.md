...
**Audited base:** `d36010c2`; live activation evidence is recorded in
...
| Terminal-first Codex, Claude Code, and Cowork onboarding                                   | Public CLI `0.1.3`; live linked `apero` key; green `doctor`; key-free runtime descriptors; verified child-process key injection; `docs/team-onboarding.md`                                           | **Proven**     | Each real pilot links, launches Codex/Claude with `maestro-brain run`, and records one Ask receipt. Cowork import may remain manual.                          |
