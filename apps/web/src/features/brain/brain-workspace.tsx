...
type EditorRevisionFence = {
  readonly documentId: string | null;
  readonly revisionKey: string | null;
};

export function readWorkspaceEditorRevisionFence(
  current: EditorRevisionFence,
  selected: EditorRevisionFence,
  saved: EditorRevisionFence = { documentId: null, revisionKey: null },
): string | null {
                ...
                <BrainEditorPane
                  ...
                  onSaveMarkdown={(markdown) => {
                    ...
                    void onSaveMarkdown(saveArgs).then((result) => {
                      if (attemptId !== saveAttemptRef.current) return;
