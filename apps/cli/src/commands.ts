...
const helpResult = (): CliResult =>
  cliSuccess(
    [
      ...
      "  pnpm brain ask <question>",
      "  pnpm brain search <query>",
      ...
      "  pnpm brain setup <runtime>",
      "  pnpm brain doctor",
      "  pnpm brain <command> --help",
      "",
      "Advanced template-development commands (offline; not the hosted Brain)",
      "  pnpm brain describe | operations list | api catalog | mcp tools",
    ].join("\n") + "\n",
  );
